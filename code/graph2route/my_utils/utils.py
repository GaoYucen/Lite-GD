...
def get_common_params():
    ...
    parser.add_argument('--max_task_num',  type=int, default=7, help = 'maxmal number of task')
    parser.add_argument('--dataset', default='logistics', type=str, help='food_pd or logistics')
    parser.add_argument('--pad_value', type=int, default=8, help='food servce, max node num is 25')
    ...
    parser.add_argument('--num_epoch', type=int, default=10, help='number of epochs to train (default: 1000)')
