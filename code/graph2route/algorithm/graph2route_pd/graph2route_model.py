...
class GCNRU(nn.Module):
    ...
    def forward(self, E_ed, V, V_reach_mask, V_pt, E_sd, V_ft, start_idx, V_dt, V_num,
        ...
        """
        B, N, H = V_reach_mask.shape[0], self.max_nodes, self.gcn_hidden_dim #B代表cases
...
def save2file(params):
    ...
    head = [
        ...
        # metric result
        'lsd', 'lmd', 'krc', 'hr@1', 'hr@2', 'hr@3', 'hr@4', 'hr@5', 'hr@6', 'hr@7',
        'ed', 'acc@1', 'acc@2', 'acc@3', 'acc@4', 'acc@5', 'acc@6', 'acc@7',
